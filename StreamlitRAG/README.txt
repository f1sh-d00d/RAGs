This app is a RAG system that runs entirely on your machine. Simply upload any files you want to ask questions about, and ask away!

This program assumes you have the llama 3.2 installed.
